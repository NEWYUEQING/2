...
class SpecificTextualPrompt(nn.Module):
    ...
    def forward(self, im_features, class_idxs, use_bias):
        ...
        print('123456',class_idxs)
       # print(len(self.classnames_list))
        classnames = [self.classnames_list[class_idxs[i]] for i in range(len(class_idxs))]
        ...
        # textual prompts e.g.: a event frame of
